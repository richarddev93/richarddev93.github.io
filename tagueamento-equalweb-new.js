function prefixBaseUrl() {
    ...
    switch (true) {
        case verifyBaseUrl('loja.suvinil.com.br') || verifyBaseUrl('loja.hml.suvinil.com.br'):
            return 'loja-online';
            break;
        case verifyBaseUrl('suvinil.com.br/encontre-seu-pintor'):
...
(function(window, document) {
    ...
    var switchEvents = (cta) => {
        ...
        switch (type) {
            case 'INDmainMenuAccBtn0':
                var idExpanded = cta.getAttribute('id-expanded');
                var expanded = 'true' === cta.getAttribute('expanded');
    ...
    var handleButtons = (buttons) => {
        var countButtonExpanded = 0;
        for (var i = 0, n = buttons.length; i < n; i++) {
            if (buttons[i]) {
                if (buttons[i].getAttribute('id') === "INDmainMenuAccBtn0") {
                    buttons[i].setAttribute('id-expanded', countButtonExpanded)
                    buttons[i].setAttribute('expanded', true);
    ...
    var addEvents = function() {
        ...
        if (countAddedEvents == 0) {
            ...
            var buttonsExpanded = document.getElementById('INDmainMenuAccBtn0');
