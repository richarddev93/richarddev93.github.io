(function (window,document){
  ...
  var countAddedEvents= 0;
    ...
    var handleSelect = () => {
      ...
      console.log("Listando select",select)
    ...
    var addEvents = function(){
      ...
      if (countAddedEvents == 0){
        ...
        if (selectLanguage) {
          //var value = selectLanguage.options[selectLanguage.selectedIndex].text;

          //console.log("value",value)
          selectLanguage.addEventListener('change', ()=> handleSelect());
  ...
  function checkJSLoaded (){
    console.log('tagueamento equalweb loaded')

    var btnAccessibility=document.getElementById('INDmenu-btn');
    btnAccessibility.addEventListener('click', () => setTimeout(addEvents,3000));
  }
